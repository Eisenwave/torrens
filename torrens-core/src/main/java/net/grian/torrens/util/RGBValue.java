...
public interface RGBValue {
    ...
    /**
     * Returns the hue of the rgb value (in HSB color model).
     *
     * @return the hue
     */
    public default float getHue() {
        return ColorMath.hue(getRGB());
    }
    
    /**
     * Returns the saturation of the rgb value (in HSB color model).
     *
     * @return the saturation
     */
    public default float getSaturation() {
        return ColorMath.saturation(getRGB());
    }
    
    /**
     * Returns the brightness of the rgb value (in HSB color model).
     *
     * @return the brightness
     */
    public default float getBrightness() {
        return ColorMath.brightness(getRGB());
    }
