...
/**
 * A block structure which stores blocks in a tree structure with leaves being single blocks or arrays of blocks.
 * <p>
...
public class TreeBlockStructure implements BlockStructure {
    ...
    /**
     * Returns the resolution of the top-level nodes or leafs stored in this structure.
     *
    ...
    /**
     * Returns the amount of total allocated volume in blocks.
     *
     * @return the amount of total allocated volume
     */
    ...
    private static class BlockCubeNode extends AbstractNode {
        ...
        @Override
        public int getId(int x, int y, int z) {
            return Byte.toUnsignedInt(arrayId[indexOf(x, y, z)]);
        }
