...
public class Texture implements Serializable, BaseTexture, Iterable<Texture.Pixel> {
    ...
    public final static int DEFAULT_BACKGROUND = ColorMath.INVISIBLE_WHITE;
    ...
    public static Texture wrap(int[] argb, int width, int height) {
        validate(argb, width, height);
        return new Texture(argb, width, height, DEFAULT_BACKGROUND, true);
    }
    ...
    public static Texture wrap(BufferedImage image) {
        ...
        return new Texture(argb, width, height, getBackground(image), true);
    }
    ...
    private Texture(int[] rgb, int width, int height, int background, boolean wrapper) {
    ...
    private Texture(Texture copyOf) {
        this.background = copyOf.background;
        this.wrapper = false;
    ...
    /**
     * Sets the background color of this texture.
     *
    ...
    /**
     * Returns whether this texture is a wrapper of any data, such as an ARGB int-array.
     *
     ...
     */
    public PixelCanvas getGraphics() {
